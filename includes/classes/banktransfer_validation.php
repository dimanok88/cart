...
////
// Diese function gibt die Bankinformationen aus der Datenbank zurьck*/
...
///
// Auffьllen der Konto-Nr. mit '0' auf 10 Stellen
...
/* ----- Die Funktionen der einzelnen Berechnungsmethoden ---- */
  ...
  function Mark24($AccountNo) {
    ...
    switch (substr($AccountNo,0,1)) {
      ...
      case 5 :
      case 6 :
        // deaktivert, da die Postbank diese Definition nicht einhдlt
        //$AccountNo = Substr($AccountNo,1);
        break;
      case 9 :
...
function MarkB9($AccountNo) {
        ...
        // Variante 1 - Zwei fьhrende Nullen
        ...
        // Variante 2 - Drei fьhrende Nullen
...
/* -------- Dies ist die wichtigste function ---------- */
  function CheckAccount($banktransfer_number, $banktransfer_blz) {
    ...
    $Result = 0;
    if ($BLZ == '' || strlen($BLZ) < 8) {
      return 8;  /* Keine BLZ ьbergeben */
    }
    if ($KontoNR == '') {
      return 9;  /* Keine Kontonummer ьbergeben */
    }
