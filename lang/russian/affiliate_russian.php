...
define('ENTRY_AFFILIATE_HOMEPAGE_TEXT', '&nbsp;<small><font color="#FF0000">обязательно (http://)</font></small>');
...
define('EMAIL_PASSWORD_REMINDER_BODY', 'Вы запросили новый пароль с адреса ' . $REMOTE_ADDR . '.' . "\n\n" . 'Ваш новый пароль:' . "\n\n" . '   %s' . "\n\n");
