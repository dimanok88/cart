<?php
/* -----------------------------------------------------------------------------------------
   $Id: dp.php 899 2007/02/07 13:24:46 VaM $
   ...
   (c) 2004	 xt:Commerce (dp.php,v 1.5 2003/08/13); xt-commerce.com
...
define('MODULE_SHIPPING_DP_STATUS_DESC' , 'Wollen Sie den Versand ьber die deutsche Post anbieten?');
define('MODULE_SHIPPING_DP_HANDLING_TITLE' , 'Handling Fee');
define('MODULE_SHIPPING_DP_HANDLING_DESC' , 'Bearbeitungsgebьhr fьr diese Versandart in Euro');
define('MODULE_SHIPPING_DP_TAX_CLASS_TITLE' , 'Steuersatz');
define('MODULE_SHIPPING_DP_TAX_CLASS_DESC' , 'Wдhlen Sie den MwSt.-Satz fьr diese Versandart aus.');
define('MODULE_SHIPPING_DP_ZONE_TITLE' , 'Versand Zone');
define('MODULE_SHIPPING_DP_ZONE_DESC' , 'Wenn Sie eine Zone auswдhlen, wird diese Versandart nur in dieser Zone angeboten.');
...
define('MODULE_SHIPPING_DP_ALLOWED_DESC' , 'Geben Sie <b>einzeln</b> die Zonen an, in welche ein Versand mцglich sein soll. zb AT,DE');
