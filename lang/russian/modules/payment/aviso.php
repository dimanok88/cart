...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_AVISO_TEXT_TITLE', 'AvisoSMS (мобильная коммерция - оплата с мобильного телефона)');
  define('MODULE_PAYMENT_AVISO_TEXT_PUBLIC_TITLE', 'AvisoSMS (мобильная коммерция - оплата с мобильного телефона)');
  define('MODULE_PAYMENT_AVISO_TEXT_ADMIN_DESCRIPTION', 'Модуль оплаты AvisoSMS<br />Как правильно настроить модуль читайте <a href="http://vamshop.ru/faq.php/faq_id/70/question/Nastroika-modulya-oplaty-WebMoney-Merchant" target="_blank"><u>здесь</u></a>.');
...
define('MODULE_PAYMENT_AVISO_STATUS_TITLE' , 'Разрешить модуль WebMoney');
...
define('MODULE_PAYMENT_AVISO_ID_TITLE' , 'WM ID:');
define('MODULE_PAYMENT_AVISO_ID_DESC' , 'Укажите Ваш WM ID');
define('MODULE_PAYMENT_AVISO_WMR_TITLE' , 'Ваш WMR кошелёк:');
define('MODULE_PAYMENT_AVISO_WMR_DESC' , 'Укажите номер Вашего WMR кошелька');
...
define('MODULE_PAYMENT_AVISO_SECRET_KEY_TITLE' , 'Секретный ключ');
define('MODULE_PAYMENT_AVISO_SECRET_KEY_DESC' , 'В данной опции укажите Ваш ключ, указанный в опции Secret Key на сайте AvisoSMS.');
