...
if(PRODUCT_IMAGE_INFO_ACTIVE == 'true') {
	...
	vam_mkdir_recursive(DIR_FS_CATALOG_INFO_IMAGES, dirname($products_image_name));

	list($width, $height) = vam_get_image_size(DIR_FS_CATALOG_ORIGINAL_IMAGES . $products_image_name, PRODUCT_IMAGE_INFO_WIDTH, PRODUCT_IMAGE_INFO_HEIGHT);
