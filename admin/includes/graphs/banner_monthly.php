<?php
/* --------------------------------------------------------------
   $Id: banner_monthly.php 899 2007-02-08 12:28:21 VaM $   
   ...
   (c) 2004 xt:Commerce (banner_monthly.php,v 1.6 2003/08/18); xt-commerce.com
  ...
  $banner_stats_query = vam_db_query("select month(banners_history_date) as banner_month, sum(banners_shown) as value, sum(banners_clicked) as dvalue from " . TABLE_BANNERS_HISTORY . " where banners_id = '" . $banner_id . "' and year(banners_history_date) = '" . $year . "' group by banner_month");
