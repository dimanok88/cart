<?php
/* -----------------------------------------------------------------------------------------
   $Id: vam_get_short_description.inc.php 976 2007-02-07 10:51:57 VaM $
   ...
   (c) 2004 xt:Commerce (vam_get_short_description.inc.php,v 1.3 2004/08/25); xt-commerce.com

   Released under the GNU General Public License 
   ---------------------------------------------------------------------------------------*/
   
  function vam_get_short_description($product_id, $language = '') {
